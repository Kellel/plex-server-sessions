...
var be = ["media_player.plex_*", "media_player.plex_client_service_*"], xe = (e) => e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), Se = (e) => RegExp(`^${xe(e).replace(/\\\*/g, ".*")}$`), Ce = (e, t) => {
	...
	if (t.show_media_title) {
		let t = e.attributes.media_series_title, n = e.attributes.media_title;
		if (typeof t == "string" && typeof n == "string") return `${t}: ${n}`;
		if (typeof n == "string") return n;
	}
	if (t.show_client_name) {
		let t = e.attributes.player_source ?? e.attributes.friendly_name;
	...
	render() {
      ...
      <ha-card>
        ...
        ${e.length > 0 ? R`
            ...
            ` : R`<div class="empty">No Plex sessions found.</div>`}
      </ha-card>
    `;
	}
	getVisibleEntities() {
